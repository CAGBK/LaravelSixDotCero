...
<div class="nav-ruleta"  class="md-12">
  ...
  <?php $__currentLoopData = $points; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <h2 style="color: rgb(44, 171, 102); text-align: right;margin: -33px 33px -16px 165px;" class="font-weight-bold">Pregunta <?php echo e($point->number_question); ?>/<?php echo e($challenge->number_questions); ?></h2>
...
<?php echo $__env->make('layouts.challenge', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DSIT-Saturno-5689A\Documents\LaravelSixDotCero\resources\views/challenge/ruleta.blade.php ENDPATH**/ ?>