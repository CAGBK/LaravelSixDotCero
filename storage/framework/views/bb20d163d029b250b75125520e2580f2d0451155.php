                ...
                <div class="container cn-confirm">
                    <div class="row" style="display: flex;justify-content: center;align-items: center;">
                        ...
                        <div class="form-group <?php echo e($errors->has('number_questions') ? ' has-error ' : ''); ?> nav-font">
                            <div class="col-md-12">
                                <div class="input-group">
                                    <?php echo Form::number('number_questions', NULL, array('id' => 'number_questions', 'class' => 'form-control input-c-questions', 'placeholder' => 'C/Preguntas', 'min' => "1", 'max'=>"100" , 'required',  'readonly' )); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.challenge', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DSIT-Saturno-5689A\Documents\LaravelSixDotCero\resources\views/challenge/edit.blade.php ENDPATH**/ ?>