        ...
        <?php echo Form::open(['route' => 'search-users', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'search_users']); ?>
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    ...
                    <a href="#" class="input-group-addon btn button-card" id="search_trigger" data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('usersmanagement.tooltips.submit-search')); ?>" >
...
<?php /**PATH C:\Users\dsgut\OneDrive\Escritorio\Prueba\LaravelSixDotCero\resources\views/partials/search-users-form.blade.php ENDPATH**/ ?>