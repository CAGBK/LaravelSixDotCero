              ...
              <div class="card-body">
                  <form action="<?php echo e(route('ruta_new_brand')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="question[]" id="question" class="form-control js-example-basic-multiple"  multiple="multiple" >
...
<?php echo $__env->make('home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\d.gutierrezg\Desktop\LaravelSixDotCero\resources\views/linebrand/newbrand.blade.php ENDPATH**/ ?>