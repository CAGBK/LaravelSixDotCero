    ...
    <div class="container">
        <fieldset id="checkArrayUsers">
            <div class="form-card">
                <div class="row">
                    <div class="col-12">
                        <h2 class="challenge-name-title">Crear Desafío</h2>
                        <h2 class="challenge-subtitle">Selecciona participantes a los que invitar!</h2>
                    </div>
                ...
                <div class="form-group has-feedback row <?php echo e($errors->has('check_user') ? ' has-error ' : ''); ?> ">
                    <div class="col-md-12">
                        ...
                        <table id="users-check" class="table">
                            <thead>
                                <tr>
                                    <th class="sorting_asc label-users">
                                        Usuarios
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <div class="div-select-all">
                                ...
                                <input value="All" class="" type="checkbox" id="selectAll" name="selectAll" value="all">
                                <svg viewBox="0 0 21 21">
                                    <path d="M5,10.75 L8.5,14.25 L19.4,2.3 C18.8333333,1.43333333 18.0333333,1 17,1 L4,1 C2.35,1 1,2.35 1,4 L1,17 C1,18.65 2.35,20 4,20 L17,20 C18.65,20 20,18.65 20,17 L20,7.99769186"></path>
                                </svg>
                                <label class="label-all" for="">Seleccionar todos los usuarios</label>
                                </label>
                            </div>
                            <?php if($users): ?>
                            <tbody>
        ...
        <fieldset id="checkArrayBrands">
            <div class="form-card">
                <div class="row">
                    <div class="col-7">
                        <h2 class="challenge-name-title">Tipo de Desafío</h2>
                        <h2 class="challenge-subtitle">Seleccione la marca</h2>
                    </div>
                </div>
        ...
        <fieldset>
            <div class="form-card">
                <div class="row">
                    <div class="col-7">
                        <h2 class="challenge-name-title">Confirmación del Desafío</h2>
                        <h2 class="challenge-subtitle">Completa los campos</h2>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.challenge', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DSIT-Saturno-5689A\Documents\LaravelSixDotCero\resources\views/challenge/index.blade.php ENDPATH**/ ?>