                    ...
                    <div class="card-body">
                        <div class="card-body">
                            <?php echo Form::model($question,['route' => ['update_question', $question->id], 'method' => 'put']); ?>
                                ...
                                <div class="form-group has-feedback row <?php echo e($errors->has('question') ? ' has-error ' : ''); ?> nav-font">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <?php echo Form::text('question', $question->question_name, array('id' => 'question', 'class' => 'form-control', 'required'=>'required')); ?>
                                ...
                                <div class="form-group has-feedback row <?php echo e($errors->has('answer[]') ? ' has-error ' : ''); ?> nav-font">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <?php echo Form::text('answer[]', $answer->name, array('id' => 'answer[]', 'class' => 'form-control', 'required'=>'required')); ?>
                                ...
                                <?php if (Auth::check() && Auth::user()->hasPermission('edit.question')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dsgut\Desktop\LaravelSixDotCero\resources\views/questionanswer/edit-question.blade.php ENDPATH**/ ?>