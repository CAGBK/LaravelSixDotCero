<li class="notification-box">
    <div class="row">
        ...
        <div class="col-lg-8 col-sm-8 col-8">
            ...
            <div>
                Te ha invitado a un desafio llamado <?php echo e($notification->data['challenge_name']); ?>

            </div>
            <small class="text-warning"><?php echo e($notification->created_at); ?></small>
        </div>    
    </div>
</li><?php /**PATH C:\Users\dsgut\OneDrive\Escritorio\LaravelSixDotCero\resources\views/partials/notification/replied_to_thread.blade.php ENDPATH**/ ?>