                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('ruta_new_question')); ?>" method="POST">
                                ...
                                <div class="form-group has-feedback row <?php echo e($errors->has('question') ? ' has-error ' : ''); ?> nav-font">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <?php echo Form::text('question', NULL, array('id' => 'question', 'class' => 'form-control', 'placeholder' => 'Pregunta...', 'required'=>'required')); ?>
                                ...
                                <div class="form-group has-feedback row <?php echo e($errors->has('answer[]') ? ' has-error ' : ''); ?> nav-font">
                                    <?php echo Form::label('answer[]', 'Respuesta 0', array('class' => 'col-md-3 control-label'));; ?>

                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <?php echo Form::text('answer[]', NULL, array('id' => 'answer[]', 'class' => 'form-control', 'placeholder' => 'Respuesta 0', 'required'=>'required')); ?>
                                ...
                                <div class="form-group has-feedback row <?php echo e($errors->has('answer[]') ? ' has-error ' : ''); ?> nav-font">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <?php echo Form::text('answer[]', NULL, array('id' => 'answer[]', 'class' => 'form-control', 'placeholder' => 'Respuesta 1', 'required'=>'required')); ?>
                                ...
                                <div class="form-group has-feedback row <?php echo e($errors->has('answer[]') ? ' has-error ' : ''); ?> nav-font">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <?php echo Form::text('answer[]', NULL, array('id' => 'answer[]', 'class' => 'form-control', 'placeholder' => 'Respuesta 2', 'required'=>'required')); ?>
                                ...
                                <div class="form-group has-feedback row <?php echo e($errors->has('answer[]') ? ' has-error ' : ''); ?> nav-font">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <?php echo Form::text('answer[]', NULL, array('id' => 'answer[]', 'class' => 'form-control', 'placeholder' => 'Respuesta 3', 'required'=>'required')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dsgut\Desktop\LaravelSixDotCero\resources\views/questionanswer/new.blade.php ENDPATH**/ ?>