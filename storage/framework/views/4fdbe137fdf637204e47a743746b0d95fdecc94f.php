              ...
              <div class="card-body">
                <?php echo Form::model($category,['route' => ['update_line', $category->id], 'method' => 'put']); ?>
                    ...
                    <div class="form-group has-feedback row <?php echo e($errors->has('line') ? ' has-error ' : ''); ?> nav-font">
                      ...
                      <div class="col-md-9">
                          <div class="input-group">
                              <?php echo Form::text('line', $category->name, array('id' => 'line', 'class' => 'form-control', 'placeholder' => 'Nombre de Linea...', 'required'=>'required')); ?>
                    ...
                    <div class="form-group has-feedback row <?php echo e($errors->has('description') ? ' has-error ' : ''); ?> nav-font">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <?php echo Form::text('description', $category->description, array('id' => 'description', 'class' => 'form-control', 'placeholder' => 'Descripción de Linea...', 'required'=>'required')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dsgut\Desktop\LaravelSixDotCero\resources\views/linebrand/edit.blade.php ENDPATH**/ ?>