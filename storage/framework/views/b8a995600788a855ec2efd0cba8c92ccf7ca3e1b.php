                  ...
                  <form action="<?php echo e(route('ruta_new_brand')); ?>" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-md-9">
                          <div class="input-group">
                              <?php echo Form::text('name', NULL, array('id' => 'name', 'class' => 'form-control general-input', 'placeholder' => 'Nombre de Marca...', 'required'=>'required')); ?>
                    ...
                    <div class="form-group has-feedback row <?php echo e($errors->has('description') ? ' has-error ' : ''); ?> nav-font">
                      ...
                      <div class="col-md-9">
                          <div class="input-group">
                              <?php echo Form::text('description', NULL, array('id' => 'description', 'class' => 'form-control general-input', 'placeholder' => 'Descripción', 'required'=>'required')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dsgut\Desktop\LaravelSixDotCero\resources\views/linebrand/newbrand.blade.php ENDPATH**/ ?>