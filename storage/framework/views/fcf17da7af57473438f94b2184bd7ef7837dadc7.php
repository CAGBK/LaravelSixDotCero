                ...
                <?php echo csrf_field(); ?>
                      ...
                      <div class="col-md-9">
                          <div class="input-group">
                              <?php echo Form::text('name', $brand->name, array('id' => 'name', 'class' => 'form-control general-input', 'placeholder' => 'Nombre de Marca...', 'required'=>'required')); ?>
                    ...
                    <div class="form-group has-feedback row <?php echo e($errors->has('description') ? ' has-error ' : ''); ?> nav-font">
                      ...
                      <div class="col-md-9">
                          <div class="input-group">
                              <?php echo Form::text('description', $brand->description, array('id' => 'description', 'class' => 'form-control general-input', 'placeholder' => 'Descripción', 'required'=>'required')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dsgut\Desktop\LaravelSixDotCero\resources\views/linebrand/edit-brand.blade.php ENDPATH**/ ?>