...
return [
    ...
    */
    ...
    'max'            => [
        ...
        'array'   => 'El :attribute may not have more than :max articulos.',
    ],
    'mimes'     => 'El :attribute debe ser un archivo de type: :values.',
    'mimetypes' => 'El :attribute debe ser un archivo de type: :values.',
    'min'       => [
        'numeric' => 'El :attribute al menos debeser :min.',
        'file'    => 'El :attribute al menos debeser :min kilobytes.',
        'string'  => 'El :attribute al menos debeser :min caracteres.',
    ...
    'required_unless'      => 'El :attribute es requerido a no ser que :other es en :values.',
    'required_with'        => 'El :attribute es requerido cuando :values es presente.',
    'required_with_all'    => 'El :attribute es requerido cuando :values es presente.',
    'required_without'     => 'El :attribute es requerido cuando :values no es presente.',
