                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {!! Form::open(array('url' => 'users/' . $user->id, 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete')) !!}
                                                    ...
                                                    {!! Form::button(trans('usersmanagement.buttons.delete'), array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width: 100%;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Borrar Usuario', 'data-message' => '¿Estás seguro de que deseas eliminar a este usuario?')) !!}
                                                {!! Form::close() !!}
                                            </td>
                                            <td>
