                ...
                <div class="card card-login">
                    <div class="card-header header-card text-white">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('users') }}" class="btn button-card" data-toggle="tooltip" data-placement="left" title="{{ trans('usersmanagement.tooltips.back-users') }}">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'users.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('email') ? ' has-error ' : '' }} nav-font">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('first_name') ? ' has-error ' : '' }} nav-font">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('last_name') ? ' has-error ' : '' }} nav-font">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('role') ? ' has-error ' : '' }} nav-font">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('password') ? ' has-error ' : '' }} nav-font">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="password">
                                                <i class="fa fa-fw {{ trans('forms.create_user_icon_password') }} nav-font" aria-hidden="true"></i>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('password_confirmation') ? ' has-error ' : '' }} nav-font">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="password_confirmation">
                                                <i class="fa fa-fw {{ trans('forms.create_user_icon_pw_confirmation') }} nav-font" aria-hidden="true"></i>
                                            </label>
                                        </div>
                                    </div>
