        ...
        {!! Form::open(['route' => 'search-users', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'search_users']) !!}
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    ...
                    <a href="#" class="input-group-addon btn button-card" id="search_trigger" data-toggle="tooltip" data-placement="bottom" title="{{ trans('usersmanagement.tooltips.submit-search') }}" >
